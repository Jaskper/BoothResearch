...
variable_names = ["DY", "PE", "CAPE", "B/M", "TRES", "DFY", "DFR", "TERM", "L-INFL", "D/E", "NTIS", "SVAR", "MA", "MOM", "CSP", "BY","NO/S","PRC","OIL-AL","SI","OIL-AG","OIL-WT","BDI","VIX","IC","PY","LI","GAP","CAY","EXP","ACC","CF"];
...
X_ECON=xlsread(input_file,input_sheet,'f2:ak1081');
%kitchen_table = table();
